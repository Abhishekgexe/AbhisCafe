...
public class FeaturedVerAdapter extends RecyclerView.Adapter<FeaturedVerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.decscription.setText ( list.get ( position ) .getDesciption ( ) ) ;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView imageView;
        TextView name,decscription,rating,timing;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            decscription = itemView.findViewById(R.id.detailed_des);
